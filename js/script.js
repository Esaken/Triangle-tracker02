function myFunction(){
   var inputs = document.getElementsByFormName("sides");
   var Side1=parseInt(document.getElementById('id=Side1').value);
   var Side2=parseInt(document.getElementById('id=Side2').value);
   var Side3=parseInt(document.getElementById('id=Side3').value);
